...
componentDidMount() {
  ...
  setTimeout(() => {
    const welcomeElement = document.getElementsByClassName("welcome-container")[0];
    sidebarElement.classList.toggle("collapsed");
    if(welcomeElement) {
      welcomeElement.classList.add("none");
    }
  }, 7000);
}
render() {
  return (
    <div className="welcome-container" style={{zIndex: '10000000', position: 'fixed', width: '100vw', height: '100vh'}}>
